...
class ST_Hint(Enum):
    alternatives = ('default', 'eastAsia', 'cs')

class ST_Shd(Enum):
    alternatives =(
        'solidhorzStripe', 'vertStripe', 'reverseDiagStripe',
        'diagStripe', 'horzCross', 'diagCross', 'thinHorzStripe',
        'thinVertStripe', 'thinReverseDiagStripe', 'thinDiagStripe',
        'thinHorzCross', 'thinDiagCross', 'pct5', 'pct10', 'pct12',
        'pct15', 'pct20', 'pct25', 'pct30', 'pct35', 'pct37', 'pct40',
        'pct45', 'pct50', 'pct55', 'pct60', 'pct62', 'pct65', 'pct70',
        'pct75', 'pct80', 'pct85', 'pct87', 'pct90', 'pct95')


class ST_PresetColorVal(Enum):
    alternatives = COLOR_NAMES

class ST_HighlightColor(Enum):
    alternatives = (
